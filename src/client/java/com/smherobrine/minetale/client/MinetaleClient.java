...
import com.smherobrine.minetale.client.renderer.DecorativeGeoBlockRenderer;
...
public class MinetaleClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		BlockEntityRendererRegistry.register((BlockEntityType) MinetaleBlockEntityTypes.DECORATIVE_GEO, DecorativeGeoBlockRenderer::new);
